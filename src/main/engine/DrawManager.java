...
public final class DrawManager {
    ...
    /**
     * Draws an main.entity, using the appropriate image.
     *
     * @param entity
     *                  Entity to be drawn.
     * @param positionX
    ...
    public void drawEntity(final Entity entity, final int positionX, final int positionY) {
        ...
        // 2P mode: start with the main.entity's own color
	...
	/**
	 * Draws number of remaining lives on main.screen.
	 *
	...
	/**
	 * Draws current coin count on main.screen.
	 *
	 * @param screen
	 *               Screen to draw on.
	 * @param coins
    ...
    /**
     * Draws a thick line from side to side of the main.screen.
     *
     * @param screen
     *                  Screen to draw on.
     * @param positionY
    ...
    /**
     * Draws basic content of game over main.screen.
     *
     * @param screen
     *                     Screen to draw on.
     * @param acceptsInput
